...
class AllProductsSection extends Component {
  ...
  changeSearchInput = searchValue => {
    this.setState({titleSearch: searchValue})
  }

  keyDownEvent = codeValue => {
    if (codeValue === 13) {
      this.getProducts()
    }
  }
      ...
      <>
        {check === true ? (
          ...
          <div className="no-products-container">
            ...
            />
            <p className="head">No Products Found</p>
            <p className="text">
  ...
  renderFailureView = () => (
    <div className="failure-container">
      ...
      />
      <p className="head">Ooops! Something Went Wrong</p>
      <p className="text">
  ...
  render() {
    ...
    switch (apiStatus) {
      case apiStatusConstants.success:
        requiredUi = this.renderProductsList()
        break
      case apiStatusConstants.failure:
        requiredUi = this.renderFailureView()
        break
      case apiStatusConstants.loading:
        requiredUi = this.renderLoader()
        break
      default:
        requiredUi = null
    }
    ...
    return (
      <div className="all-products-section">
        ...
        <FiltersGroup
          ...
          category={category}
          rating={rating}
          changeSearch={this.changeSearchInput}
